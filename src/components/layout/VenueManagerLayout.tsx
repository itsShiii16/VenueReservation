...
export const VenueManagerLayout: React.FC<VenueManagerLayoutProps> = ({ children }) => {
          ...
          <Card className="max-w-md w-full border-red-200 bg-white shadow-lg rounded-xl overflow-hidden">
            <CardContent className="p-8 flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-zinc-600 text-sm">
                You must be logged in as a Venue Manager to access this dashboard.
              </p>
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 font-sans">
      <Sidebar role="VENUE_MANAGER" />
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Navbar for Mobile View Toggle & User Actions */}
        <PublicNavbar />
